...
export function buildFaqs({ at }: DemoContext): DemoCollection {
  ...
  const raw: Array<Omit<Faq, "updatedAt">> = [
    ...
    { id: "faq-scholarship", category: "finance", order: 2, question: "Are scholarships or bursaries available?", answer: "Yes: the UCL Merit Scholarship and the Need-Based Bursary. Applications open once a year, and details are on the Finance Office service page and in announcements." },
    // ---- IT
    ...
    { id: "faq-wellbeing", category: "student-life", order: 2, question: "Where can I get counselling or emotional support?", answer: "The Wellbeing and Counselling Centre in the Student Centre offers free, confidential sessions. Walk in or book online. A 24-hour crisis line is also available." },
    // ---- Facilities
    ...
    { id: "faq-emergency", category: "general", order: 2, question: "What should I do in an emergency?", answer: "Call the 24-hour security desk on +94 11 555 0999 or go to the Main Gate. Emergency announcements appear at the top of the app and in Notifications." },
  ];
